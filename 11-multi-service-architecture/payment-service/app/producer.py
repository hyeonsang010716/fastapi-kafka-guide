"""
결제 서비스 Kafka 프로듀서
결제 처리 결과를 payment.result 토픽으로 발행
"""
...
from .config import KAFKA_BOOTSTRAP_SERVERS, TOPIC_PAYMENT_RESULT
...
async def publish_payment_result(event_data: dict):
    ...
    logger.info("결제 결과 이벤트 발행: order_id=%s, type=%s",
